...
<h3>The Information Station</h3>
		<div class="row">
			<div class="large-12 columns">
				<div class="panel">
					<p>First incantation of the <a href="https://github.com/breeezzz/Internal">Breez Development tool</a> - an Open Source web application available on GitHub.	It's been created to bridge the developer/client gap and assist in project and content management.</p>
					<p>Please report any bugs to the <a href="mailo:brz1080@gmail.com">admin.</a></p>
				</div>
			</div>
			</div>
